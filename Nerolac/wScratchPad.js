(function ($) {
  ...
  $.fn.wScratchPad.defaults = {
    size        : 80,          // The size of the brush/scratch.
    bg          : '#cacaca',  // Background (image path or hex color).
    // bg          : '#b5152a',  // Background (image path or hex color).
    fg          : '#b5152a',  // Foreground (image path or hex color).
    ...
    cursor      : 'url("./images/roller.png"), auto' // Set cursor.
  };
